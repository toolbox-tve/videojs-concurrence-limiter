          ...
          var wdf = function wdf() {
            ...
            _this5.makeRequest(options.updateurl, {
              ...
              if (error) {
                ...
                _videoJs2['default'].log('concurrenceview: updateurl retry later', _this5.updateFailsCount, options.maxUpdateFails);
...
concurrenceLimiter.VERSION = '0.4.8';
